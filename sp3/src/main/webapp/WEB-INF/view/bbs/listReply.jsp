		...
		<c:forEach var="vo" items="${listReply}">
			<tr height='35' style='background: #eeeeee;'>
				...
				<td width='50%'
					...
					align='right'><span>${vo.created }</span> | <c:choose>
						<c:when
			...
			<tr>
				<td colspan='2' valign='top' style='padding: 5px 5px;'>${vo.content }</td>
			</tr>
			...
			<tr>
				...
				<td style='padding: 7px 5px;' align='right'>
					<button type='button' class='btn btnSendReplyLike'
						data-replyNum='${vo.replyNum }' data-replyLike='1'>
						좋아요 <span>${vo.likeCount }</span>
					</button>
					<button type='button' class='btn btnSendReplyLike'
						data-replyNum='${vo.replyNum }' data-replyLike='0'>
						싫어요 <span>${vo.disLikeCount }</span>
					</button>
				</td>
			</tr>
