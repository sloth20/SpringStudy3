...
<body>
	...
	<div id="loadingLayout"
		style="display: none; position: absolute; left: 0; top: 0; width: 100%; height: 100%; z-index: 9000; background: #eeeeee;">
		<img id="loadingImage" src="<%=cp%>/resource/images/shycat2.gif">	
	</div>
