			...
			<c:forEach var="vo" items="${listFile}">
				<tr height="35" style="border-bottom: 1px solid #cccccc;">
					<td colspan="2" align="left" style="padding-left: 5px;">첨부 : <a
						href="<%=cp%>/notice/download?fileNum=${vo.fileNum}">${vo.originalFilename}</a>
		...
		<table
			...
			<tr height="45">
				<td width="300" align="left">
					<button type="button" class="btn" onclick="updateBoard();"
						${sessionScope.member.userId!="admin"?"style='pointer-events:none'":""}>수정</button>
					<button type="button" class="btn" onclick="deleteBoard();"
						${sessionScope.member.userId!="admin"?"style='pointer-events:none'":""}>삭제</button>
